...
import br.com.alura.forum_hub.domain.usuario.DadosAutenticacaoUsuario;
...
public class AutenticacaoController {
    ...
    @PostMapping
    public ResponseEntity efetuarLogin(@RequestBody @Valid DadosAutenticacaoUsuario dadosUsuario) {
